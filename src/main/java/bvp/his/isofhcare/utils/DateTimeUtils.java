...
public class DateTimeUtils {
    ...
    public static String getCurrentDateStr() {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern(AppConst.DATE_FORMAT);
    ...
    public static String currentTimeFormat(String format) throws ParseException{
    ...
    public static int DateOfBirthToAge(Date dateOfBirth) throws ParseException{
        if(dateOfBirth!=null){
            int yearBorn=dateOfBirth.getYear();
            int yearNow= new Date().getYear();
            if(yearBorn < yearNow){
                return yearNow-yearBorn;
            }else if(yearBorn==yearNow){
                return 1;
            }
        }
        return 0;
